...
public class GenericHandler {
     ...
     *
     * @param resultClass The class of the result tag
     * @param debug       True, if you need a DEBUG mode
     * @throws InstantiationException
     * @throws IllegalAccessException
     */
     ...
     * @param resultClass    The class of the result tag
     * @param debug          True, if you need a DEBUG mode
     * @param parserTypeName Factory method parameter to select parser implementation
     * @throws InstantiationException
     * @throws IllegalAccessException
     */
     ...
     * device)
     *
     * @param typeName special name "android" means use the native parser from
     *                 Android framework
