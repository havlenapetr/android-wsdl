    ...
    private void okButtonActionPerformed(java.awt.event.ActionEvent evt) {
        ...
        if (destFile != null) {
            if (!destFile.exists() || !destFile.isDirectory()) {
                ...
                File destDir = this.controller.generateJavaFromWSDL(this.cxfFile, destFile, this.wsdlTextField.getText());
                JOptionPane.showMessageDialog(this, "The WS Client Stub generated in the directory: \"" + destDir + "\"");
            }
        } else {
            JOptionPane.showMessageDialog(this, "Please choose a directory");
            return;
